package com.github.binitabharati.kafkapoc.case4;
	...
	private void sendMsg() throws Exception {
		...
		for (int i = startIdx ; i < endIdx ; i++) {		
			...
			try {
				...
				long tt2 = System.nanoTime() - startTime2;
				logger.info("Sending message with key  =  "+ i + " caused Exception after waiting for response for time = "+TimeUnit.SECONDS.convert(tt2, TimeUnit.NANOSECONDS));		
