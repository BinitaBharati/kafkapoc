package com.github.binitabharati.kafkapoc.case12;
...
public class Consumer implements Runnable{
	...
	public void consume() {
		try {
			  int pollCount = 0;
			  boolean pollDataFound = false;
			  while (true) { 
				  if (!pollDataFound || pollCount < 4) {
				      ...
				      if (records.isEmpty()){
				    	  ...
				    	  logger.info(name + "-topic = " + " about to commit async with pollCount = "+pollCount);
